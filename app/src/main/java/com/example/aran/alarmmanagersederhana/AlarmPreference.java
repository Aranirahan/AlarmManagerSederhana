...
/**
 * Created by aran on 11/12/17.
 */
//TODO 1 Menyimpan nilai-nilai terakhir yang kita set sewaktu membuat obyek alarm
    //Mekanisme penyimpanan berbasis pasangan kunci dan nilai (Key Value Pair)
    //memanfaatkan fasilitas SharedPreference
