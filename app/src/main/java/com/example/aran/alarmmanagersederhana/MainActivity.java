package com.example.aran.alarmmanagersederhana;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtRepeatingMessage = (EditText)findViewById(R.id.edt_one_time_alarm_message);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_one_time_alarm_date){
            ...
            new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
                @Override
                //TODO 2 Fungsi onDateSet akan dipanggil ketika kita memilih tanggal yang kita inginkan,
                // kemudian kita set variable calOneTimeData dengan tanggal yang kita pilih
